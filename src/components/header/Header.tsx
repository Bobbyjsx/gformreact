        ...
        <div className=" ">
         <div id="Header" className="flex flex-row  justify-between grow-0">
          <div className="flex flex-row justify-around gap-x-5 grow-0">
              ...
              <input  className="text-black outline-none caret-transparent capitalize cursor-cell font-semibold text-xl pt-4" name="head" value={inputs[index].title} contentEditable="false" placeholder="Untitled Form"
              />
            </div>
