...
function App() {
  ...
  const [purple, setPurple]=useState({borderColor: `${color}`})

  const handleSwap= () =>{
     setPurple({borderColor: `${inputColor}`})
  }

  return (
    <div className="App">
      <App className="text-black p-4 bg-white" >
        <div className="flex flex-row gap-x-[70%]">
         ...
         <section className="flex flex-row gap-11 mt-[3%] w-[20%] mx-auhref">
      ...
      <div className=' bg-slate-200 p-4'>
        <div className='p-0  w-[60%] mx-auhref  border-2 rounded-lg bg-white' style={{borderColor: `${color}`}}>
